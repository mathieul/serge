...
var _user$project$Tasker_Model$Model = F2(
	function (a, b) {
		return {config: a, route: b};
	});
var _user$project$Tasker_Model$AppConfig = F4(
	function (a, b, c, d) {
		return {id: a, name: b, email: c, accessToken: d};
	});
var _user$project$Tasker_Model$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _user$project$Tasker_Model$HomeRoute = {ctor: 'HomeRoute'};
var _user$project$Tasker_Model$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _user$project$Tasker_Model$NoOp = {ctor: 'NoOp'};

var _user$project$Tasker_Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Tasker_Model$HomeRoute, _evancz$url_parser$UrlParser$top),
		_1: {ctor: '[]'}
	});
var _user$project$Tasker_Routing$parseLocation = function (location) {
	var _p0 = A2(_elm_lang$core$Debug$log, 'location', location);
	var _p1 = A2(_evancz$url_parser$UrlParser$parseHash, _user$project$Tasker_Routing$matchers, location);
	if (_p1.ctor === 'Just') {
		return _p1._0;
	} else {
		return _user$project$Tasker_Model$NotFoundRoute;
	}
};

var _user$project$Tasker_Init$initialAppConfig = function (rawConfig) {
	return {id: rawConfig.id, name: rawConfig.name, email: rawConfig.email, accessToken: rawConfig.access_token};
};
var _user$project$Tasker_Init$initialModel = F2(
	function (rawConfig, route) {
		return {
			config: _user$project$Tasker_Init$initialAppConfig(rawConfig),
			route: route
		};
	});
var _user$project$Tasker_Init$init = F2(
	function (rawConfig, result) {
		var currentRoute = _user$project$Tasker_Routing$parseLocation(result);
		return {
			ctor: '_Tuple2',
			_0: A2(_user$project$Tasker_Init$initialModel, rawConfig, currentRoute),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _user$project$Tasker_Init$ConfigFromJs = F4(
	function (a, b, c, d) {
		return {id: a, name: b, email: c, access_token: d};
	});

var _user$project$Tasker_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'NoOp') {
			return A2(
...
var _user$project$Tasker_Views_Home$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Home Route'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Authenticated. Now let\'s implement something....'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Tasker_Views_Main$notFoundView = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('NOT FOUND ROUTE'),
		_1: {ctor: '[]'}
	});
var _user$project$Tasker_Views_Main$view = function (model) {
	var _p0 = model.route;
	if (_p0.ctor === 'HomeRoute') {
		return _user$project$Tasker_Views_Home$view(model);
	} else {
		return _user$project$Tasker_Views_Main$notFoundView;
	}
};

var _user$project$Tasker$main = A2(
	_elm_lang$navigation$Navigation$programWithFlags,
	_user$project$Tasker_Model$UrlChange,
	{
		init: _user$project$Tasker_Init$init,
		update: _user$project$Tasker_Update$update,
		subscriptions: function (_p0) {
			return _elm_lang$core$Platform_Sub$none;
		},
		view: _user$project$Tasker_Views_Main$view
	})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
...
var Elm = {};
Elm['Tasker'] = Elm['Tasker'] || {};
if (typeof _user$project$Tasker$main !== 'undefined') {
    _user$project$Tasker$main(Elm['Tasker'], 'Tasker', {"types":{"unions":{"Tasker.Model.Msg":{"args":[],"tags":{"UrlChange":["Navigation.Location"],"NoOp":[]}}},"aliases":{"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Tasker.Model.Msg"},"versions":{"elm":"0.18.0"}});
}
